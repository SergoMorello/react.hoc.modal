...
const style_module_css_1 = __importDefault(require("../styles/style.module.css"));
const Container = (0, react_1.forwardRef)((props, ref) => {
    const { children, style, className, name, title, disableClose, theme = 'lite', effect = 'scale', render, footerRender, onHide } = props;
    ...
    console.log(providerContext.modals);
