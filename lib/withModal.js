...
const withModal = (WrappedComponent, config) => {
    ...
    const setState = (data) => {
        if (typeof currentRef.current.setState !== 'function')
            return;
    ...
    const container = () => (0, react_1.forwardRef)((_a, ref) => {
        ...
        const [stateData, setStateData] = (0, react_1.useState)();
        ...
        (0, react_1.useImperativeHandle)(currentRef, () => (Object.assign(Object.assign({}, modalRef.current), { setState: setStateData })));
